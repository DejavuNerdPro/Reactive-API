...
const project_router_1 = __importDefault(require("./project_router"));
const role_router_1 = __importDefault(require("./role_router"));
const team_member_router_1 = __importDefault(require("./team_member_router"));
...
app.use('/api/team-member', team_member_router_1.default);
